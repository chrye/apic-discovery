...
@description('APIM name. If provided, this name will be used. Otherwise, a name will be generated using the resourceSuffix.')
param apimName string = ''

// if apimName is passed in, use it. otherwise use the following logic to randomly generate it
var apiManagementName = !empty(apimName) ? apimName : 'apim-${resourceSuffix}'
