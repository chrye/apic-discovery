...
param apiName string = 'outline-generator-api'

param a2aPath string = 'outline-agent'
param a2aName string = 'outline-agent'
param a2aDisplayName string = 'Outline Generator A2A Agent'
param a2aDescription string = 'A2A agent for generating structured article outlines'
...
// Policy for Agent Card endpoint
...
// Policy for message/send - calls the underlying REST API
