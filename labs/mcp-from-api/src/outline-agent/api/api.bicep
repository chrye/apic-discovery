...
param apiPath string = 'outline-generator'
param apiName string = 'outline-generator-api'
param apiDisplayName string = 'Outline Generator API'
param apiDescription string = 'API for generating structured article outlines'
