...
param apiName string = 'summary-generator-api'

param a2aPath string = 'summary-agent'
param a2aName string = 'summary-agent'
param a2aDisplayName string = 'Summary Generator A2A Agent'
param a2aDescription string = 'A2A agent for generating concise text summaries'
...
// Operation: POST / - A2A Message Send
resource messageSendOperation 'Microsoft.ApiManagement/service/apis/operations@2024-06-01-preview' = {
  ...
  properties: {
    ...
    description: 'Handles A2A protocol JSON-RPC 2.0 messages.'
    method: 'POST'
    urlTemplate: '/'
    request: {
      representations: [
