...
param apiPath string = 'summary-generator'
param apiName string = 'summary-generator-api'
param apiDisplayName string = 'Summary Generator API'
param apiDescription string = 'API for generating concise text summaries'
