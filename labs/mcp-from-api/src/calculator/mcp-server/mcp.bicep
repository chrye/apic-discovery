...
param apiName string = 'calculator-api'
param operationName string = 'calculate'

param mcpPath string = 'calculator-mcp'
param mcpName string = 'calculator-mcp'
param mcpDisplayName string = 'Calculator MCP'
param mcpDescription string = 'MCP for basic arithmetic calculations'
