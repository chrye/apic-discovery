...
param apiPath string = 'title-generator'
param apiName string = 'title-generator-api'
param apiDisplayName string = 'Title Generator API'
param apiDescription string = 'API for generating catchy blog post titles'
